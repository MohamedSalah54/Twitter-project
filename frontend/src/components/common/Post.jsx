...
const Post = ({ post }) => {
	...
	const {mutate:deletePost ,isPendding:isDeleting} = useMutation({
		mutationFn : async () =>{
			try{	
		...
		onSuccess:()=>{
			toast.success("Post deleted successflly")
	...
	const {mutate:likePosts, isPending:isLiking} = useMutation({
		...
		onSuccess:(updatedLikes)=>{
			//this is not a best solution because it's gonna be refresh
			// queryClient.invalidateQueries({queryKey:['posts']})
